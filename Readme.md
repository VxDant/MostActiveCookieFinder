...
Replace [src/main/java/com/findmostactivecookie/log/cookie_log.csv] with the path to your cookie log file and [date] with the date you want to analyze in the format YYYY-MM-DD.
